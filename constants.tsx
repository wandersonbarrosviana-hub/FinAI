...
export const BANKS: BankInfo[] = [
  ...
  { id: 'itau', name: 'Itaú', color: '#EC7000', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/e0/Itau_logo_2023.svg' },
  { id: 'nubank', name: 'Nubank', color: '#8A05BE', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/f/f7/Nubank_logo_2021.svg' },
  { id: 'bradesco', name: 'Bradesco', color: '#CC092F', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/5b/Bradesco_logo.svg' },
  { id: 'bb', name: 'Banco do Brasil', color: '#FCF200', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/f/ff/Banco_do_Brasil_logo.svg' },
  { id: 'santander', name: 'Santander', color: '#EC0000', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/b3/Santander_Logo.svg' },
  { id: 'caixa', name: 'Caixa', color: '#005CA9', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/26/Logo_Caixa_Econ%C3%B4mica_Federal.svg' },
  { id: 'inter', name: 'Inter', color: '#FF7A00', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/ba/Banco_Inter_logo.svg' },
  { id: 'c6', name: 'C6 Bank', color: '#222222', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/a/a2/C6_Bank_Logo.svg' },
  { id: 'safra', name: 'Safra', color: '#AF9049', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/0/07/Banco_Safra_logo.png' },
  { id: 'pan', name: 'Banco Pan', color: '#00AEEF', logoUrl: 'https://upload.wikimedia.org/wikipedia/pt/c/c9/Logo_Banco_Pan.png' },
  { id: 'pagbank', name: 'PagBank', color: '#35C24D', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/a/a5/PagSeguro_logo.svg' },

  // Coluna Direita - Corretoras
  { id: 'xp', name: 'XP Investimentos', color: '#000000', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/3/30/XP_Investimentos_logo.svg' },
  { id: 'rico', name: 'Rico', color: '#FF4500', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/77/Rico_logo.svg' },
  { id: 'clear', name: 'Clear', color: '#00FFFF', logoUrl: 'https://upload.wikimedia.org/wikipedia/pt/4/4b/Clear_Corretora_Logo.png' },
  { id: 'avenue', name: 'Avenue', color: '#003A70', logoUrl: 'https://upload.wikimedia.org/wikipedia/pt/a/a2/Avenue_Securities_Logo.png' },
  { id: 'warren', name: 'Warren', color: '#EE2E5D', logoUrl: 'https://upload.wikimedia.org/wikipedia/pt/d/db/Warren_logo.png' },
  { id: 'toro', name: 'Toro Investimentos', color: '#6227B1', logoUrl: 'https://upload.wikimedia.org/wikipedia/pt/b/bc/Toro_Investimentos_Logo.png' },
  { id: 'nuinvest', name: 'NuInvest', color: '#8A05BE', logoUrl: 'https://upload.wikimedia.org/wikipedia/pt/8/87/NuInvest_Logo.png' },
  { id: 'modalmais', name: 'Modalmais', color: '#141414', logoUrl: 'https://upload.wikimedia.org/wikipedia/pt/8/8d/Modalmais_Logo.png' },
