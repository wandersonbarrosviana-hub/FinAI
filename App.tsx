    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex overflow-hidden selection:bg-sky-500/30">
      ...
      <main className={`flex-1 flex flex-col transition-all duration-300 mb-[88px] md:mb-0 ml-0 ${sidebarOpen ? 'md:ml-64' : 'md:ml-20'}`}>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-6 relative scrollbar-hide">
          {userRole === 'admin' && <div className={currentView === 'admin' ? '' : 'hidden'}><AdminPanel /></div>}
          ...
          <div className={currentView === 'investments' ? '' : 'hidden'}>
            <div className="flex flex-col items-center justify-center h-full min-h-[60vh] gap-6">
              ...
              <div className="text-center">
                <h2 className="text-2xl font-black text-slate-800 dark:text-white tracking-tight">Em breve controle de investimentos</h2>
                <p className="text-slate-400 dark:text-slate-500 font-medium mt-2 text-sm">Estamos trabalhando para trazer o melhor módulo de investimentos para você.</p>
              </div>
            </div>
          </div>
        </div>
